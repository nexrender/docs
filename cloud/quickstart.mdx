...
- A single JSON job payload to customize your render
 ...
 [Download Postman Collection](../downloads/nexrender-cloud.postman_collection.json)

---

## Prerequisites

- An active Nexrender Cloud account [Ping Us](https://www.nexrender.com/contact)
- Your API Key (grab it from your dashboard) - Nexrender Cloud account [Ping Us](https://app.nexrender.com/team/settings)
...
In case of .zip archive, make sure you have created a
...
> ⚠️ **Important:**\
> Your archive must be structured correctly, or rendering will fail.\
