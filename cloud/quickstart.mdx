...
- An active Nexrender Cloud account **Ping Us**
- Your API Key (grab it from your dashboard) - **link in the account**
...
>
> 👉 [Learn how to prepare your archive correctly →](#️-preparing-your-template-for-upload)
