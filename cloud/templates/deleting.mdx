...
<AccordionGroup>
  <Accordion title="When Should You Delete a Template?">
  ...
  <Accordion title="Delete via API">
    To delete a template, call:
    ...
    curl -X DELETE https://api.nexrender.com/api/v2/templates/01JTGM9GCR71JV7EJYDF45QAFD \
  ...
  <Accordion title="What Happens After Deletion?">
    | Component         | Status                                             |
    | ----------------- | -------------------------------------------------- |
  ...
  <Accordion title="Edge Cases & Notes">
  ...
  <Accordion title="Suggested Practice">
