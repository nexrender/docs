...
description: "How to upload custom fonts for use in Nexrender Cloud projects."
keywords: ["nexrender fonts", "upload font", "custom font", "ttf after effects"]

If your template uses custom fonts not included in Adobe After Effects by default, you’ll need to upload those fonts so they’re available during rendering.
